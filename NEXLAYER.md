# Nexlayer — apprise-api

**Live:** [https://relaxed-weasel-apprise-api.cloud.nexlayer.ai](https://relaxed-weasel-apprise-api.cloud.nexlayer.ai)  

**Runtime:** python · **Port:** 8000 · **Deploy branch:** main

---

## How this deployment works

**apprise-api** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01kece1xyh817dwff7wnarhkxd/apprise-api:9f1ffa3-fix1"
      path: /
      servicePorts:
        - 8000
      vars: {}
